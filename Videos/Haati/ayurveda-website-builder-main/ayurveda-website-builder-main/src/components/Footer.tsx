  ...
  <footer className="bg-primary text-primary-foreground">
    <div className="container mx-auto px-4 py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-heading text-lg font-bold">Vaidyam Hospital</span>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm">
            <div className="flex items-start gap-2 opacity-80">
              ...
              <span>Vaidyam Hospital Wellness Center, Uttarakhand, India</span>
            </div>
      ...
      <div className="border-t border-primary-foreground/20 mt-12 pt-6 text-center text-sm opacity-60">
        © {new Date().getFullYear()} Vaidyam Hospital Wellness Center. All rights reserved.
      </div>
    </div>
  </footer>
);
